...
import { isConfigured, ensureUser, saveRuntimeEnv } from "../lib/supaApi";
...
export default function UserDemo() {
  ...
  return (
    <main style={{ padding: 24, fontFamily: "system-ui, sans-serif" }}>
      ...
      <button onClick={handleEnsure} style={{ ...btn, marginTop: 12 }} disabled={loading}>
